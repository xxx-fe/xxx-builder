...
([
    ...
    function(module, exports, __webpack_require__) {
        ...
        var _avalon = __webpack_require__(10);
    ...
    function(module, exports, __webpack_require__) {
        ...
        (function(module) {
            ...
            (function webpackUniversalModuleDefinition(root, factory) {
                if ((false ? 'undefined' : _typeof(exports)) === 'object' && (false ? 'undefined' : _typeof(module)) === 'object') module.exports = factory();
                ...
                else if ((typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object') exports["avalon"] = factory();
                else root["avalon"] = factory();
            })(undefined, function() {
                return ( /******/ function(modules) { // webpackBootstrap
                ...
                }, , , /* 1 */ /* 2 */ /* 3 */ /***/ function(module, exports) { /* WEBPACK VAR INJECTION */
                    (function(global) { //avalon的核心,这里都是一些不存在异议的*核心*方法与属性
                        ...
                        avalon.shadowCopy(avalon, {
                            noop: function noop() {}, //切割字符串为一个个小块，以空格或逗号分开它们，结合replace实现字符串的forEach
                            rword: rword,
                            inspect: {}.toString,
                            ohasOwn: {}.hasOwnProperty,
                            log: function log() {
                                if (hasConsole && avalon.config.debug) { // http://stackoverflow.com/questions/8785624/how-to-safely-wrap-console-log
                                    Function.apply.call(console.log, console, arguments);
                                }
                            },
                            warn: function warn() {
                                if (hasConsole && avalon.config.debug) {
                                    var method = console.warn || console.log; // http://qiang106.iteye.com/blog/1721425
                            ...
                            oneObject: function oneObject(array, val) {
                        ...
                        module.exports = avalon; /* WEBPACK VAR INJECTION */
                    }).call(exports, function() {
                        return this;
                    }()); /***/
                }, /* 4 */ /***/ function(module, exports) { /* WEBPACK VAR INJECTION */
                    (function(global) {
                        var window = global;
                        var browser = {
                            window: window,
                        ...
                        module.exports = browser; /* WEBPACK VAR INJECTION */
                    }).call(exports, function() {
                        return this;
                    }()); /***/
                }, , /* 5 */ /* 6 */ /***/ function(module, exports) {
                    var cssHooks = {};
                    ...
                    avalon.shadowCopy(avalon, {
                        ...
                        css: function css(node, name, value, fn) { //读写删除元素节点的样式
                        ...
                        isObject: function isObject(a) { //1.6新增
		     ...
		     avalon.range(0)
		     => []*/
                        range: function range(start, end, step) { // 用于生成整数数组
                            step || (step = 1);
                            if (end == null) {
                                end = start || 0;
                                start = 0;
                        ...
                        hyphen: function hyphen(target) { //转换为连字符线风格
                            return target.replace(rhyphen, '$1-$2').toLowerCase();
                        },
                        camelize: function camelize(target) { //提前判断，提高getStyle等的效率
                        ...
                        escapeRegExp: function escapeRegExp(target) { //http://stevenlevithan.com/regex/xregexp/
                            //将字符串安全格式化为正则表达式的源码
                            return (target + '').replace(rescape, '\\$&');
                        },
                        Array: {
                            merge: function merge(target, other) { //合并两个数组 avalon2新增
                                target.push.apply(target, other);
                            },
                            ensure: function ensure(target, item) { //只有当前数组不存在此元素时只添加它
                                if (target.indexOf(item) === -1) {
                                    return target.push(item);
                                }
                            },
                            removeAt: function removeAt(target, index) { //移除数组中指定位置的元素，返回布尔表示成功与否
                                return !!target.splice(index, 1).length;
                            },
                            remove: function remove(target, item) { //移除数组中第一个匹配传参的那个元素，返回布尔表示成功与否
                    ...
                    var UUID = 1;
                    module.exports = { //生成事件回调的UUID(用户通过ms-on指令)
                        avalon: avalon,
                        getLongID: function getLongID(fn) {
                            return fn.uuid || (fn.uuid = avalon.makeHashCode('e'));
                        }, //生成事件回调的UUID(用户通过avalon.bind)
                        getShortID: function getShortID(fn) {
                    ...
                    function kernel(settings) {
                        for (var p in settings) {
                            if (!avalon.ohasOwn.call(settings, p)) continue;
                            var val = settings[p];
                            if (typeof kernel.plugins[p] === 'function') {
                                kernel.plugins[p](val);
                            } else if (_typeof(kernel[p]) === 'object') {
                    ...
                    var plugins = {
                        interpolate: function interpolate(array) {
                            var openTag = array[0];
                            var closeTag = array[1]; /*eslint-disable */
                            if (openTag === closeTag) {
                    ...
                    avalon.mix(filters, {
                        ...
                        truncate: function truncate(str, length, truncation) { //length，新字符串长度，truncation，新字符串的结尾的字段,返回新字符串
                            length = length || 30;
                    ...
                    function number(number, decimals, point, thousands) { //form http://phpjs.org/functions/number_format/
                        //number 必需，要格式化的数字
                    ...
                    module.exports = number; //处理 货币 http://openexchangerates.github.io/accounting.js/
                    /***/
                }, /* 10 */ /***/ function(module, exports) {
                    var rsurrogate = /[\uD800-\uDBFF][\uDC00-\uDFFF]/g;
                    var rnoalphanumeric = /([^\#-~| |!])/g;

                    function escape(str) { //将字符串经过 str 转义得到适合在页面中显示的内容, 例如替换 < 为 &lt
		 ...
		 */
                    ...
                    function limitBy(input, limit, begin) {
                        ...
                        if (type !== 'array' && type !== 'object') throw 'limitBy只能处理对象或数组'; //尝试将limit转换数值
                ...
                }, , , , , , , , /* 19 */ /* 20 */ /* 21 */ /* 22 */ /* 23 */ /* 24 */ /* 25 */ /* 26 */ /***/ function(module, exports) { // https://github.com/rsms/js-lru
                    ...
                    function fixScript(wrapper) {
                        var els = typeof wrapper.querySelectorAll !== 'undefined' ? wrapper.querySelectorAll('script') : wrapper.getElementsByTagName('script');
                        if (els.length) {
                            for (var i = 0, el; el = els[i++];) {
                                if (scriptTypes[el.type]) { //以偷龙转凤方式恢复执行脚本功能
                ...
                }, , , , , /* 28 */ /* 29 */ /* 30 */ /* 31 */ /* 32 */ /***/ function(module, exports) { //http://www.feiesoft.com/html/events.html
                    ...
                    module.exports = {
                        ...
                        compositionend: true,
                        select: true, //http://blog.csdn.net/lee_magnum/article/details/17761441
                        cut: true,
                        copy: true,
                        paste: true,
                        beforecut: true,
                        ...
                        for (var i = 0, elem; elem = nodes[i++];) {
                            if (elem.nodeType === 1) {
                                ...
                                if (vm && !vm.$element) {
                                    ...
                                    vm.$element = elem;
                                    var now = new Date(); //IE6-8下元素的outerHTML前面会有空白
                ...
                }, , /* 35 */ /* 36 */ /***/ function(module, exports, __webpack_require__) {
                    var parseView = __webpack_require__(37);
                    var update = __webpack_require__(43);
                    avalon.important = function(elem, vid) { //如果vmodel还不存在,直接返回
                        var wid = elem.props.wid;
                        var vm = avalon.vmodels[vid];
                        if (!vm) {
                            return elem;
                        } else if (typeof avalon.caches[wid] === 'string') {
                            var body = avalon.caches[wid]; //生成模板函数,并进行相关缓存
                    ...
                    avalon.directive('important', {
                        priority: 1,
                        parse: function parse(binding, num, elem) {
                            delete elem.props['ms-important'];
                            var wid = elem.props.wid || (elem.props.wid = avalon.makeHashCode('w'));
                            var fn = parseView([elem], num) + '\n\nreturn vnodes' + num; //将渲染函数的某一部分存起来,渲在c方法中转换为函数
                            avalon.caches[wid] = fn;
                            elem.isVoidTag = true;
                            return ['vnode' + num + '.props.wid = ' + avalon.quote(wid), 'vnode' + num + ' = avalon.important(vnode' + num + ',' + avalon.quote(binding.expr) + ')'].join('\n') + '\n';
                        },
                        diff: function diff(cur, pre, steps, name) {
                            if (pre.props[name] !== cur.props[name]) {
                                update(cur, this.update, steps, 'important');
                            }
                        },
                        update: function update(node, vnode) {
                ...
                }, /* 38 */ /***/ function(module, exports, __webpack_require__) { //缓存求值函数，以便多次利用
                    ...
                    var wrapDuplex = function wrapDuplex(arr) {
                    ...
                    function parseExpr(str, category) {
                        ...
                        if (category === 'on') {
                            ...
                            ret = ['function ms_on($event){', 'try{', '\tvar __vmodel__ = this;', '\t' + body, '}catch(e){', quoteError(str, category), '}', '}'];
                            filters.unshift(2, 0);
                        } else if (category === 'duplex') { //从vm中得到当前属性的值
                            var getterBody = ['function (__vmodel__){', 'try{', 'return ' + body + '\n', '}catch(e){', quoteError(str, category), '}', '}'];
                            evaluatorPool.put('duplex:' + cacheID, wrapDuplex(getterBody)); //给vm同步某个属性
                            var setterBody = ['function (__vmodel__,__value__){', 'try{', '\t' + body + ' = __value__', '}catch(e){', quoteError(str, category), '}', '}'];
                            evaluatorPool.put('duplex:set:' + cacheID, wrapDuplex(setterBody)); //对某个值进行格式化
                            if (input.length) {
                            ...
                            ret = ['(function(){', 'try{', 'var __value__ = ' + body, category === 'text' ? 'return __value__ == null ? "" :__value__' : 'return __value__', '}catch(e){', quoteError(str, category), '\treturn ""', '}', '})()'];
                            filters.unshift(3, 0);
                        }
                    ...
                    var Cache = __webpack_require__(26); //缓存求值函数，以便多次利用
                    ...
                    function parseBindings(props, num, elem) {
                        ...
                        for (var i in props) {
                            ...
                            } else { //IE6-8下关键字不能直接当做对象的键名，需要用引号括起来
                ...
                }, /* 44 */ /***/ function(module, exports, __webpack_require__) { // 抽离出来公用
                    var update = __webpack_require__(43);
                    ...
                    avalon.directive('controller', {
                        ...
                        parse: function parse(binding, num, elem) {
                            ...
                            var vm = 'vm' + num;
                            var ret = ['if(!vnodes' + num + '.vm){ vnodes' + num + '.vm = __vmodel__}', '__vmodel__ = vnodes' + num + '.vm || __vmodel__', 'vnode' + num + '.props["ms-controller"] = ' + id + ';', 'var ' + vm + ' = avalon.vmodels[' + id + ']', 'if(!' + vm + '){return }', 'vnode' + num + '.bottom = ' + vm, 'if(__vmodel__){', 'vnode' + num + '.top = __vmodel__', 'var __id__ = __vmodel__.$id+ "_" + ' + id, "__vmodel__ = avalon.caches[__id__] || (avalon.caches[__id__] = avalon.mediatorFactory(__vmodel__," + vm + '))', 'vnode' + num + '.mediator = __vmodel__', '}else{', '__vmodel__ = ' + vm, '}', 'if(!avalon.skipController(__fast__, vnode' + num + '.bottom)){ '];
                            return ret.join('\n') + '\n';
                        },
                        diff: function diff(cur, pre, steps, name) {
                            if (pre.props[name] !== cur.props[name]) {
                        ...
                        update: function update(node, vnode) {
                            ...
                            if (!bottom.$render) {
                                var topRender;
                                (function() {
                                    var bottomRender = function bottomRender() {
                                        return topRender(0, bottomRender.$id);
                                    };
                                    topRender = top.$render;
                                    if (!topRender.$id) {
                                        topRender.$id = top.$id;
                                    }
                ...
                }, , , /* 45 */ /* 46 */ /* 47 */ /***/ function(module, exports) {
		 ...
		 */
                    ...
                    avalon.directive('css', {
                        parse: function parse(binding, num) {
                    ...
                    function parseDisplay(elem, val) { //用于取得此类标签的默认display值
                    ...
                    avalon.directive('visible', {
                        ...
                        update: function update(node, vnode) {
                            ...
                            if (show) {
                                ...
                                if (node.style.display === '' && avalon(node).css('display') === none && // fix firefox BUG,必须挂到页面上
                ...
                }, , /* 50 */ /* 51 */ /***/ function(module, exports, __webpack_require__) {
                    var rident = __webpack_require__(40).ident;
                    var update = __webpack_require__(43);
                    avalon.directive('text', {
                        parse: function parse(binding, num, vnode) {
                            vnode.children = [{
                                type: '#text',
                                nodeType: 3,
                                nodeValue: ''
                        ...
                        diff: function diff(cur, pre, steps, name) {
                            ...
                            if (curValue !== preValue || cur.children.length === 0) {
                                if (!cur.children[0]) cur.children[0] = {
                                    type: "#text",
                                    nodeType: 3
                                };
                    ...
                    avalon.directive('html', {
                        parse: function parse(binding, num, el) {
                            var isVoidTag = !!el.isVoidTag;
                            el.isVoidTag = false;
                            var ret = ["var htmlId =  " + avalon.parseExpr(binding), 'vnode' + num + '.props["ms-html"]  = htmlId;', 'vnode' + num + '._isVoidTag  = ' + isVoidTag, 'var obj  = avalon.htmlFactory(htmlId,' + num + ');', 'try{eval(" new function(){"+ obj.render +"}")}catch(e){};', 'vnode' + num + '.children = avalon.__html;'];
                            return ret.join('\n') + '\n';
                        },
                        diff: function diff(cur, pre, steps, name) {
                            var curValue = cur.props[name];
                ...
                }, /* 53 */ /***/ function(module, exports, __webpack_require__) { //根据VM的属性值或表达式的值切换类名，ms-class='xxx yyy zzz:flag'
                    //http://www.cnblogs.com/rubylouvre/archive/2012/12/17/2818540.html
                    var markID = __webpack_require__(6).getLongID;
                    var update = __webpack_require__(43);
                    var directives = avalon.directives;
                    avalon.directive('class', {
                        parse: function parse(binding, num) { //必须是布尔对象或字符串数组
                        ...
                        diff: function diff(cur, pre, steps, name) {
                            ...
                            if (Array.isArray(curValue)) { //处理复杂的一维数组
                                className = curValue.map(function(el) {
                                    return el && (typeof el === 'undefined' ? 'undefined' : _typeof(el)) === 'object' ? processBooleanObject(el) : el ? el : '';
                                }).join(' ');
                            } else if (avalon.isObject(curValue)) { //处理布尔对象
                                className = processBooleanObject(curValue);
                            } else if (curValue !== false && curValue !== null && curValue !== void 0) { //处理其他真值，如字符串，数字
                    ...
                    var quote = avalon.quote;
                    var update = __webpack_require__(43); //Ref: http://developers.whatwg.org/webappapis.html#event-handler-idl-attributes
                    // The assumption is that future DOM event attribute names will begin with
                    // 'on' and be composed of only English letters.
                    var revent = /^ms-on-([a-z]+)/;
                    var rfilters = /\|.+/g;
                    var rvar = /((?:\@|\$|\#\#)?\w+)/g;
                    var rstring = __webpack_require__(40).string; //基于事件代理的高性能事件绑定
                    avalon.directive('on', {
                        priority: 3000,
                        parse: function parse(binding, num) {
                            ...
                            if (canCache) {
                                ...
                                return vmDefine + 'vnode' + num + '.props[' + pid + '] = avalon.eventListeners.' + uuid + '\n';
                            } else { //如果闭包引用其他变量
                                return vmDefine + 'vnode' + num + '.props[' + pid + '] = ' + avalon.parseExpr(binding, 'on') + '\n';
                            }
                        },
                        diff: function diff(cur, pre, steps, name) {
                ...
                }, , /* 55 */ /* 56 */ /***/ function(module, exports) {
                    var valueHijack = false;
                    try {
                        var newSetter = function newSetter(value) { // jshint ignore:line
                        ...
                        valueHijack = true;
                    } catch (e) { //在chrome 43中 ms-duplex终于不需要使用定时器实现双向绑定了
                    ...
                    function newField(binding, vnode) {
                        ...
                        var etype = vnode.props.type; //处理数据转换器
                        ...
                        if (rchangeFilter.test(expr)) { //  expr = expr.replace(rchangeFilter, '')
                        ...
                        if (match) { // expr = expr.replace(rdebounceFilter, '')
                            if (!field.isChanged) {
                        ...
                        if (!/input|textarea|select/.test(vnode.type)) {
                            ...
                            field.type = vnode.type === 'select' ? 'select' : etype === 'checkbox' ? 'checkbox' : etype === 'radio' ? 'radio' : 'input';
                        }
                     ...
                     */
                    var refreshModel = {
                        input: function input(prop) { //处理单个value值处理
                            var field = this;
                            prop = prop || 'value';
                            var viewValue = field.element[prop];
                            var rawValue = viewValue;
                            viewValue = field.format(viewValue); //vm.aaa = '1234567890'
                    ...
                    var update = __webpack_require__(43);
                    var dir = avalon.directive('validate', { //验证单个表单元素
                        parse: function parse(binding, num) {
                        ...
                        validate: function validate(field, isValidateAll, event) {
                            ...
                            var reasons = []; //如果promises不为空，说明经过验证拦截器
                    ...
                    avalon.shadowCopy(avalon.validators, {
                        ...
                        digits: {
                            message: '必须整数',
                            get: function get(value, field, next) { //整数
                                next(/^\-?\d+$/.test(value));
                                return value;
                            }
                        },
                        number: {
                            message: '必须数字',
                            get: function get(value, field, next) { //数值
                                next(isFinite(value));
                                return value;
                            }
                        },
                    ...
                    var update = __webpack_require__(43); //ms-imporant ms-controller ms-for ms-widget ms-effect ms-if   ...
                    avalon.directive('if', {
                        priority: 6,
                        parse: function parse(binding, num) {
                            var vnode = 'vnode' + num;
                            var ret = ['var ifVar = ' + avalon.parseExpr(binding, 'if'), vnode + '.props["ms-if"] = ifVar;', 'if(!ifVar){', vnode + '.nodeType = 8;', vnode + '.directive="if";', vnode + '.nodeValue="ms-if"', '}'];
                            return ret.join('\n') + '\n';
                        },
                        diff: function diff(cur, pre, steps) {
                            cur.dom = pre.dom;
                        ...
                        update: function update(node, vnode, parent) {
                            var dtype = node.nodeType;
                            var vtype = vnode.nodeType;
                            if (dtype !== vtype) {
                                if (vtype === 1) { //要插入元素节点,将原位置上的注释节点移除并cache
                                ...
                                } else if (vtype === 8) { //要移除元素节点,在对应位置上插入注释节点
                                    avalon.applyEffect(node, vnode, {
                                        hook: 'onLeaveDone',
                                        cb: function cb() {
                                            var comment = node._ms_if_ || (node._ms_if_ = document.createComment(vnode.nodeValue));
                    ...
                    function patch(nodes, vnodes, parent, steps) {
                        ...
                        for (var i = 0, vn = vnodes.length; i < vn; i++) {
                            var vnode = vnodes[i];
                            var node = next; //IE6-8不会生成空白的文本节点，造成虚拟DOM与真实DOM的个数不一致，需要跳过,#1333
                            ...
                            if (!vnode.skipContent && vnode.children && node && node.nodeType === 1) { //处理子节点
                    ...
                    avalon.directive('for', {
                        ...
                        diff: function diff(current, previous, steps, __index__) {
                            ...
                            if (isInit) { /* eslint-disable no-cond-assign */
                                var oldCount = steps.count;
                                var cache = cur.cache = {};
                                for (i = 0; c = cur.components[i++];) { /* eslint-enable no-cond-assign */
                                    avalon.diff(c.children, [], steps);
                                    saveInCache(cache, c);
                                }
                                cur.removedComponents = {}; //如果没有孩子也要处理一下
                                isChange = cur.components.length === 0 || steps.count !== oldCount;
                            } else {
                                var cache = pre.cache;
                                if (!cache) return;
                                var newCache = cur.cache = {}; /* eslint-disable no-cond-assign */
                                for (i = 0; c = cur.components[i++];) { /* eslint-enable no-cond-assign */
                        ...
                        update: function update(startRepeat, vnode, parent) {
                            var action = vnode.action;
                            var endRepeat = vnode.endRepeat;
                            var fragment = document.createDocumentFragment();
                            if (action === 'init') { //在ms-widget中,这部分内容会先行被渲染出来
                                var hasRender = false;
                            ...
                            for (var i = 0; i < vnode.components.length; i++) {
                                ...
                                } else if (vnode.hasRender) { //添加nodes属性但不用插入节点
                                    var cnodes = com.nodes = [];
                    ...
                    function isInCache(cache, id) {
                        ...
                        if (c) {
                            ...
                            if (ctack) {
                                var a = ctack.pop();
                                delete cache[a.id];
                                if (ctack.length == 0) delete cache["***" + id];
                                return a.c;
                            }
                            var stack = [{
                                id: id,
                    ...
                    var applyEffects = function applyEffects(nodes, vnodes, opts) {
                        vnodes.forEach(function(el, i) {
                            avalon.applyEffect(nodes[i], vnodes[i], opts);
                        });
                    }; /***/
                }, , , /* 67 */ /* 68 */ /* 69 */ /***/ function(module, exports, __webpack_require__) {
                    ...
                    avalon.directive('effect', {
                        ...
                        update: function update(dom, vnode, parent, option) {
                            if (dom.animating) {
                                return;
                            }
                            dom.animating = true;
                    ...
                    var tran; //有的浏览器同时支持私有实现与标准写法，比如webkit支持前两种，Opera支持1、3、4
                    ...
                    avalon.batch = __webpack_require__(74); // dispatch与patch 为内置模块
                    var parseView = __webpack_require__(37);
                    ...
                    var VComment = vdom.VComment; //匹配只有开标签的无内容元素（Void elements 或 self-contained tags）
                    ...
                    function fixLongAttrValue(attr) {
                        return rhasString.test(attr) ? attr.replace(rlineSp, '').replace(rstring, dig) : attr;
                    }
                        ...
                        do {
                            ...
                            if (!node) { //尝试匹配注释
                                ...
                                if (match) {
                                    ...
                                    if (rspBeforeForEnd.test(nodeValue)) {
                                        var sp = nodes[nodes.length - 1]; //移除紧挨着<!--ms-for-end:xxxx-->前的空白节点
                            ...
                            if (!node) { //尝试匹配拥有闭标签的元素节点
                                ...
                                if (match) {
                                    ...
                                    var innerHTML = outerHTML.slice(match[0].length, (type.length + 3) * -1); //抽取innerHTML
                                    node = {
                                        nodeType: 1,
                                        type: type,
                                        props: props,
                            ...
                            if (node) { //从text中移除被匹配的部分
                                ...
                                if (node.nodeType === 8 && rspAfterForStart.test(node.nodeValue)) {
                                    node.signature = makeHashCode('for'); //移除紧挨着<!--ms-for:xxxx-->后的空白节点
                    ...
                    function clipOuterHTML(matchText, type) {
                        var opens = [];
                        var closes = [];
                        var ropen = tagCache[type + 'open'] || (tagCache[type + 'open'] = new RegExp('<' + type + openStr, regArgs));
                        var rclose = tagCache[type + 'close'] || (tagCache[type + 'close'] = new RegExp('<\/' + type + '>', regArgs)); /* jshint ignore:start */
                        matchText.replace(ropen, function(_, b) { //注意,页面有时很长,b的数值就很大,如
                        ...
                        }); /* jshint ignore:end */ //<div><div>01</div><div>02</div></div><div>222</div><div>333</div>
                    ...
                    function handleProps(str, props) {
                        str.replace(rnogutter, '=').replace(rnowhite, function(el) {
                            ...
                            if (arr.length === 2) {
                                if (value.indexOf('??') === 0) {
                                    value = value.replace(rfill, fill).slice(1, -1).replace(ramp, '&').replace(rquote, '"');
                                }
                            }
                            props[name] = value;
                        });
                     ...
                     * ------------------------------------------------------------
                     */
                    var patch = __webpack_require__(65); //如果正在更新一个子树,那么将它放到
                    var dirtyTrees = {};
                    var needRenderIds = [];
		 ...
		 */
                ...
                }, , , /* 77 */ /* 78 */ /* 79 */ /***/ function(module, exports, __webpack_require__) {
                    var $$midway = {};
                    ...
                    function isSkip(key, value, skipArray) { // 判定此属性能否转换访问器
                        return key.charAt(0) === '$' || skipArray[key] || typeof value === 'function' || value && value.nodeName && value.nodeType > 0;
                    }

                    function modelAdaptor(definition, old, heirloom, options) { //如果数组转换为监控数组
                        if (Array.isArray(definition)) {
                            return $$midway.arrayFactory(definition, old, heirloom, options);
                        } else if (Object(definition) === definition && typeof definition !== 'function') { //如果此属性原来就是一个VM,拆分里面的访问器属性
                            if (old && old.$id) {
                                ++avalon.suspendUpdate; //1.5带来的优化方案
                    ...
                    function makeAccessor(sid, spath, heirloom) {
                        ...
                        return {
                            ...
                            set: function set(val) {
                                ...
                                if (this.$hashcode && vm && !avalon.suspendUpdate) { //★★确保切换到新的events中(这个events可能是来自oldProxy)
                                    if (heirloom !== vm.$events) {
                                        get.heirloom = vm.$events;
                                    } //如果这个属性是组件配置对象中的属性,那么它需要触发组件的回调
                                    emitWidget(get.$decompose, spath, val, older); //触发普通属性的回调
                                    if (spath.indexOf('*') === -1) {
                                        $emit(get.heirloom[spath], vm, spath, val, older);
                                    } //如果这个属性是数组元素上的属性
                                    emitArray(sid, vm, spath, val, older); //如果这个属性存在通配符
                    ...
                    var __array__ = {
                        ...
                        contains: function contains(el) { //判定是否包含
                        ...
                        remove: function remove(el) { //移除第一个等于给定值的元素
                            return this.removeAt(this.indexOf(el));
                        },
                        removeAt: function removeAt(index) { //移除指定索引上的元素
                            if (index >>> 0 === index) {
                    ...
                    function $emit(list, vm, path, a, b, i) {
                        if (list && list.length) {
                            try {
                                ...
                                if (i - 1 > 0) $emit(list, vm, path, a, b, i - 1);
                                avalon.log(e, path);
                            }
                        }
                    }
                ...
                }, , , /* 81 */ /* 82 */ /* 83 */ /***/ function(module, exports, __webpack_require__) {
                    ...
                    module.exports = avalon; /***/
                }, /* 84 */ /***/ function(module, exports) { //这里放置存在异议的方法
                    var serialize = avalon.inspect;
                    var rwindow = /^\[object (?:Window|DOMWindow|global)\]$/;
                    var rarraylike = /(Array|List|Collection|Map|Arguments)\]$/;
                    avalon.quote = JSON.stringify; // avalon.type
                    var class2type = {};
                    ...
                    avalon.type = function(obj) { //取得目标的类型
                        ...
                        return (typeof obj === 'undefined' ? 'undefined' : _typeof(obj)) === 'object' || typeof obj === 'function' ? class2type[serialize.call(obj)] || 'object' : typeof obj === 'undefined' ? 'undefined' : _typeof(obj);
                    };
                    ...
                    avalon.isPlainObject = function(obj) { // 简单的 typeof obj === 'object'检测，会致使用isPlainObject(window)在opera下通不过
                        return serialize.call(obj) === '[object Object]' && Object.getPrototypeOf(obj) === Object.prototype;
                    ...
                    module.exports = avalon; /***/
                }, /* 86 */ /***/ function(module, exports) { //safari5+是把contains方法放在Element.prototype上而不是Node.prototype
                    ...
                    svg.innerHTML = '<circle fill="red" />'; //IE9-11,firefox,ios7,8的chrome不支持SVG元素的innerHTML,outerHTML属性
                    if (!/^\[object SVG\w*Element\]$/.test(svg.firstChild)) {
                        (function() {
                            var createSVG = function createSVG(node, parent) { /* jshint ignore:start */
                    ...
                    avalon.fn.mix({
                        hasClass: function hasClass(cls) {
                            var el = this[0] || {}; //IE10+, chrome8+, firefox3.6+, safari5.1+,opera11.5+支持classList,
                    ...
                    avalon.fn.position = function() {
                        ...
                        if (this.css("position") === "fixed") {
                            ...
                            parentOffset.left += avalon.css(offsetParent[0], "borderLeftWidth", true); // Subtract offsetParent scroll positions
                    ...
                    function showHidden(node, array) { //http://www.cnblogs.com/rubylouvre/archive/2012/10/27/2742529.html
                    ...
                    avalon.fn.offset = function() { //取得距离页面左右角的坐标
                        var node = this[0];
                        try {
                            var rect = node.getBoundingClientRect(); // Make sure element is not hidden (display: none) or disconnected
                    ...
                    var valHooks = {
                        'select:get': function self(node, ret, index, singleton) {
                            var nodes = node.children,
                                value, getter = valHooks['option:get'];
                    ...
                    var eventHooks = avalon.eventHooks; /*绑定事件*/
                    avalon.bind = function(elem, type, fn) {
                        if (elem.nodeType === 1) {
                            var value = elem.getAttribute('avalon-events') || ''; //如果是使用ms-on-*绑定的回调,其uuid格式为e12122324,
                            ...
                            if (keys.indexOf(key) === -1) {
                                keys.push(key);
                                elem.setAttribute('avalon-events', keys.join('??')); //将令牌放进avalon-events属性中
                            }
                        } else {
                    ...
                    var nativeBind = function nativeBind(el, type, fn, capture) {
                        el.addEventListener(type, fn, capture);
                    };
                    var nativeUnBind = function nativeUnBind(el, type, fn) {
                    ...
                    var eventHooks = avalon.eventHooks; //针对firefox, chrome修正mouseenter, mouseleave(chrome30+)
		     ...
		     chrome wheel deltaY 下100 上-100 */
                    ...
                    __webpack_require__(44); //处理属性样式
                    __webpack_require__(95);
                    __webpack_require__(48);
                    __webpack_require__(49); //处理内容
                    __webpack_require__(97);
                    __webpack_require__(51);
                    __webpack_require__(52); //需要用到事件的
                    __webpack_require__(53);
                    __webpack_require__(54);
                    __webpack_require__(98);
                    __webpack_require__(62);
                    __webpack_require__(63); //处理逻辑
                        ...
                        if (attrs) {
                            for (var attrName in attrs) {
                                ...
                                if (attrName === 'src' && window.chrome && node.tagName === 'EMBED') {
                                    ...
                                    if (typeof node[propName] === 'boolean') { //布尔属性必须使用el.xxx = true|false方式设值
                    ...
                    avalon.directive('duplex', {
                        ...
                        update: function update(node, vnode) {
                            ...
                            addField(node, vnode);
                            if (!avalon.msie && valueHijack === false && !node.valueHijack) { //chrome 42及以下版本需要这个hack
                    ...
                    function fixVirtualOptionSelected(cur, curValue) {
                        ...
                        for (var i = 0, option; option = options[i++];) {
                            var v = 'value' in option.props ? option.props.value : (option.children[0] || {
                                nodeValue: ''
                            }).nodeValue.trim();
                    ...
                    function initControl(cur) {
                        ...
                        var events = field.events = {}; //添加需要监听的事件
                        switch (field.type) {
                            case 'radio':
                            ...
                            case 'contenteditable':
                                if (field.isChanged) {
                                    ...
                                    if (window.webkitURL) { // http://code.metager.de/source/xref/WebKit/LayoutTests/fast/events/
                            ...
                            case 'input':
                                if (field.isChanged) {
                                    ...
                                    events.input = updateModel;
                                    if (!avalon.msie) { //https://github.com/RubyLouvre/avalon/issues/1368#issuecomment-220503284
                    ...
                    function updateModel() {
                        ...
                        if (elem.composing || elem.value === field.lastViewValue) return;
                        if (elem.caret) {
                            try {
                    ...
                    var updateField = {
                        input: function input() { //处理单个value值处理
                            this.element.value = this.viewValue;
                        },
                        radio: function radio() { //处理单个checked属性
                            var checked;
                            if (this.isChecked) {
                        ...
                        checkbox: function checkbox() { //处理多个checked属性
                            var checked = false;
                    ...
                    var patch = __webpack_require__(65);
                    var update = __webpack_require__(43); //插入点机制,组件的模板中有一些slot元素,用于等待被外面的元素替代
                    var dir = avalon.directive('widget', {
                        ...
                        parse: function parse(binding, num, elem) {
                            ...
                            var ret = ['vnode' + num + '._isVoidTag = ' + isVoidTag, 'vnode' + num + '.props.wid = "' + wid + '"', 'vnode' + num + '.template = ' + avalon.quote(elem.template), 'vnode' + num + '.props["ms-widget"] = ' + avalon.parseExpr(binding, 'widget'), 'vnode' + num + ' = avalon.component(vnode' + num + ', __vmodel__)', 'if(typeof vnode' + num + '.render === "string"){', 'avalon.__widget = [];', 'var __backup__ = __vmodel__;', '__vmodel__ = vnode' + num + '.vmodel;', 'try{eval(" new function(){"+ vnode' + num + '.render +"}");', '}catch(e){avalon.warn(e)', '}', 'vnode' + num + ' = avalon.renderComponent(avalon.__widget[0])', '}', '__vmodel__ = __backup__;'];
                            return ret.join('\n') + '\n';
                        },
                        ...
                        diff: function diff(cur, pre, steps) {
                            ...
                            if (!docker || !docker.renderCount) {
                                ...
                                var fireReady = function fireReady(dom, vnode) {
                                ...
                                cur.steps = steps; //https://github.com/RubyLouvre/avalon/issues/1390
                                ...
                                if (viewChangeObservers && viewChangeObservers.length) {
                                    ...
                                    cur.afterChange = [function(dom, vnode) {
                                        ...
                                        var curHTML = cur.outerHTML || (cur.outerHTML = avalon.vdomAdaptor(cur, 'toHTML'));
                                        if (preHTML !== curHTML) {
                        ...
                        addDisposeMonitor: function addDisposeMonitor(dom) {
                            disposeDetectStrategy.byRewritePrototype(dom);
                        },
                        replaceByComment: function replaceByComment(dom, node, parent) {
                        ...
                        replaceByComponent: function replaceByComponent(dom, node, parent) {
                ...
                }, /* 102 */ /***/ function(module, exports) { //用于IE8+, firefox
                    ...
                    avalon.component = function(name, definition) { //这是定义组件的分支,并将列队中的同类型对象移除
                        if (typeof name === 'string') {
                            ...
                            var wid = root.props.wid; //处理ms-widget的参数
                            var finalOptions = {};
                            ...
                            var componentName = root.type.indexOf('-') > 0 ? root.type : finalOptions.is;
                            var placeholder = {
                                nodeType: 8,
                                type: '#comment',
                                directive: 'widget',
                            ...
                            if (!avalon.components[componentName]) { //如果组件还没有定义,那么返回一个注释节点占位
                                return placeholder;
                            } else { //=======对用户的自定义标签进行处理===========
                                var type = root.type; //判定用户传入的标签名是否符合规格
                                ...
                                definition = avalon.components[componentName]; //开始构建组件的vm的配置对象
                                var diff = finalOptions.diff;
                                var define = finalOptions.define;
                                define = define || avalon.directives.widget.define;
                                var $id = finalOptions.$id || avalon.makeHashCode(componentName.replace(/-/g, '_'));
                                ...
                                var componentRoot = vtree[0]; //将用户标签中的属性合并到组件标签的属性里
                                ...
                                if (definition.soleSlot) {
                                    ...
                                    slots[slotName] = /\S/.test(docker.template) ? root.children : new VText('{{@' + slotName + '}}');
                                ...
                                vmodel.$events.__wid__ = wid; //触发onInit回调
                                vmodel.$fire('onInit', {
                                    type: 'init',
                                    vmodel: vmodel,
                                    wid: wid,
                    ...
                    function isCustomTag(type) {
                        return type.length > 3 && type.indexOf('-') > 0 && ralphabet.test(type.charAt(0) + type.slice(-1));
                    }
                    avalon.renderComponent = function(root) {
                        var docker = avalon.resolvedComponents[root.props.wid];
                        var order = root.order;
                        root.order = order ? 'ms-widget;;' + order : 'ms-widget';
                        ...
                        root.diff = docker.diff; //移除skipAttrs,以便进行diff
                    ...
                    function removeEmptyText(nodes) { //如果定义组件时,slot元素两旁有大片空白,且slot元素又是被一个文本节点替代时,需要合并这三个文本节点
                        for (var i = 0, el; el = nodes[i]; i++) {
                    ...
                    var makeHashCode = avalon.makeHashCode; //一个vm总是为Observer的实例
                    function Observer() {}
                    ...
                    function masterFactory(definition, heirloom, options) {
                        ...
                        for (key in keys) { //对普通监控属性或访问器属性进行赋值
                            $vmodel[key] = keys[key]; //删除系统属性
                            if (key in $skipArray) {
                                delete keys[key];
                            } else {
                                keys[key] = true;
                    ...
                    function mediatorFactory(before, after) {
                        ...
                        for (key in unresolve) {
                            if ($$skipArray[key] || accessors[key]) continue;
                    ...
                    __method__.forEach(function(method) {
                        ...
                        __array__[method] = function(a, b) { // 继续尝试劫持数组元素的属性
                            var args = [],
                                size = this.length;
                    ...
                    function makeObserver($vmodel, heirloom, keys, accessors, options) {
                        if (options.array) {
                            ...
                            var hasOwnKey = function hasOwnKey(key) {
